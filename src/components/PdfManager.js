  ...
  const getFinalHtmlContent = (boletim) => {
    ...
    if (boletim.dadosLaboratorio) {
      ...
      if (lab.assinaturaLaboratorista) {
        ...
        const assinaturaHtml = `Assinatura:<br><div style="margin-top: 5px;"><img src="${lab.assinaturaLaboratorista}" alt="Assinatura" style="max-height: 20px; max-width: 300px; object-fit: contain;" /></div>`;
