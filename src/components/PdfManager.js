  ...
  const getFinalHtmlContent = (boletim) => {
    ...
    if (boletim.dadosLaboratorio) {
      ...
      if (lab.assinaturaLaboratorista) {
        ...
        const assinaturaHtml = `Assinatura:<br><div style="margin-top: 5px;"><img src="${lab.assinaturaLaboratorista}" alt="Assinatura" style="max-height: 2px; max-width: 400px; object-fit: fill;" /></div>`;
